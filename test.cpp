...
static_assert(conjunction_v<
              is_trivially_copy_constructible<Optional<int>>, is_trivially_copy_assignable<Optional<int>>,
              is_trivially_move_constructible<Optional<int>>, is_trivially_move_assignable<Optional<int>>,
...
struct TriviallyMovableButNotCopyAssignable
{
    ...
    TriviallyMovableButNotCopyAssignable& operator=(TriviallyMovableButNotCopyAssignable&&) = default;
    TriviallyMovableButNotCopyAssignable& operator=(const TriviallyMovableButNotCopyAssignable&)
    {
        return *this;
    }
};
static_assert(is_trivially_move_constructible_v<Optional<TriviallyMovableButNotCopyAssignable>>);
...
static_assert(is_trivially_copy_constructible_v<Optional<TriviallyMovableButNotCopyAssignable>>);
...
struct TriviallyCopyableButNotMoveAssignable
{
    ...
    TriviallyCopyableButNotMoveAssignable& operator=(TriviallyCopyableButNotMoveAssignable&&) = delete;
    TriviallyCopyableButNotMoveAssignable&
    operator=(const TriviallyCopyableButNotMoveAssignable&) = default;
};
static_assert(!std::is_move_assignable_v<TriviallyCopyableButNotMoveAssignable>);
static_assert(std::is_trivially_move_constructible_v<Optional<TriviallyCopyableButNotMoveAssignable>>);
static_assert(std::is_trivially_copy_constructible_v<Optional<TriviallyCopyableButNotMoveAssignable>>);
static_assert(std::is_trivially_destructible_v<Optional<TriviallyCopyableButNotMoveAssignable>>);
static_assert(std::is_trivially_copy_assignable_v<Optional<TriviallyCopyableButNotMoveAssignable>>);
...
// The non-trivial move constructor (that won't compile because TriviallyCopyableButNotMoveAssignable
// has its move assignment operator deleted) prevents this trait from being true.
